...
Note: demo mode is documented separately in `dev/demo-mode.en.md` because it covers configuration, reset workflows, safety rules, and test-oriented seed data.
